...
import requests
from globals import AUTHORIZATION_BASE_URL, REDIRECT_URI, TOKEN_URL
...
def main() -> None:
    ...
    activity_map = plot_activities_on_map(
        activities_data,
        color_by_type=True,
        default_opacities={
            "Run": 0.15,
    ...
    output_path = os.path.join("2024", "day_15", "code", "activities_map.html")
    activity_map.save(output_path)
